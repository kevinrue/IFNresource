...
intro <-
  c(
    intro,
    "This panel shows the <font color=\"#402ee8\">Reduced dimension plot</font> from the previous panel, separating the cells into samples: unstimulated, 2500 U/ml IFN-a1, IFN-a2a, IFN-a2b, IFN-a4, IFN-a5, IFN-a6, IFN-a7, IFN-a8, IFN-a10, IFN-a14, IFN-a16, IFN-a17, IFN-a21, IFN-b, IFN-w<br/><br/>This plot receives the selection made in <font color=\"#402ee8\">Reduced Dimension Plot 1</font>"
  )
